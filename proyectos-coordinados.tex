...
\begin{boxed}
    \textbf{TÍTULO DEL PROYECTO COORDINADO (ACRÓNIMO)}:
\end{boxed}

\begin{boxed}
    \textbf{TITLE OF THE COORDINATED PROJECT (ACRONYM)}:
\end{boxed}

\textbf{\textit{DATOS DE LOS SUBPROYECTOS - SUBPROJECTS DATA}}

\textbf{\underline{SUBPROYECTO 1}:}\\
\textbf{IP 1 COORDINADOR 1} (Nombre y apellidos):\\
\textbf{IP 2 COORDINADOR 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\textbf{\underline{SUBPROYECTO 2}:}\\
\textbf{IP 1} (Nombre y apellidos):\\
\textbf{IP 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\textbf{\underline{SUBPROYECTO 3}:}\\
\textbf{IP 1} (Nombre y apellidos):\\
\textbf{IP 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\textbf{\underline{SUBPROYECTO 4}:}\\
\textbf{IP 1} (Nombre y apellidos):\\
\textbf{IP 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\textbf{\underline{SUBPROYECTO 5}:}\\
\textbf{IP 1} (Nombre y apellidos):\\
\textbf{IP 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\textbf{\underline{SUBPROYECTO 6}:}\\
\textbf{IP 1} (Nombre y apellidos):\\
\textbf{IP 2} (Nombre y apellidos):\\
\textbf{TÍTULO - \textit{TITLE}}:

\section{Justificación y contribución de la coordinación}

Se deberá justificar de manera precisa y clara la necesidad de la coordinación para alcanzar los objetivos del proyecto coordinado, incluyendo el valor añadido que se espera alcanzar con la presentación de un proyecto coordinado, frente a un proyecto individual.

Se deberá incluir una descripción clara de los mecanismos de coordinación previstos para la ejecución eficaz del proyecto coordinado.
...
Se deberá justificar la \textbf{adecuación} de la propuesta a las características de la convocatoria, así como la adecuación de la investigación a desarrollar a la modalidad de proyecto seleccionada.
...
Si la memoria se presenta en la modalidad de investigación orientada, se deberá identificar la prioridad temática, de las recogidas en el anexo III, y \textbf{justificar} la selección de la misma.
...
Si dentro de la \textbf{modalidad de investigación orientada se presenta al tipo RTA}, se deberá, además, indicar la línea de investigación prioritaria, de las recogidas en el anexo VI y justificar la contribución de la propuesta a la misma.

\section{Objetivos, metodología y plan de trabajo}

\subsection{Objetivos generales y específicos}

Se deberán describir los \textbf{objetivos generales y específicos}, del proyecto, enumerándolos brevemente, con claridad, precisión y de manera realista (acorde con la duración prevista del proyecto y la composición del equipo de investigación y/o de trabajo).

Se deberá indicar expresamente de qué objetivos específicos se hará responsable cada uno de los subproyectos que componen el proyecto coordinado.

En los subproyectos con dos investigadores/as principales, deberá indicarse expresamente de qué objetivos específicos se hará responsable cada uno/a de ellos/as.

Se deberá detallar la interacción entre los distintos objetivos y las tareas de los subproyectos, de manera que permita valorar la interconexión entre los diferentes subproyectos.

\subsection{Descripción de la metodología}

Describa con detalle \textbf{la metodología} propuesta en relación con los objetivos y con el estado del arte, resaltando la novedad y/o adecuación de la misma y destacando aquellas \textbf{etapas} críticas cuyo resultado pueda afectar a la viabilidad del plan de trabajo previsto o requerir un reajuste del mismo.
...
Se deberá incluir una descripción del \textbf{impacto científico-técnico} que se espera de los resultados del proyecto, tanto a nivel nacional como internacional, identificando, en su caso, aquellos resultados que permitan avanzar en el conocimiento científico-técnico de carácter interdisciplinar.

En el caso de que el proyecto se presente en \textbf{la modalidad investigación orientada} se deberá identificar la contribución de los resultados esperables a la prioridad temática seleccionada.
...
Deberá incluir \textbf{un plan de comunicación científica} de los resultados del proyecto, poniendo énfasis en aquellas actuaciones de especial relevancia y diferentes a las habituales.
...
Describa una justificación cualitativa de la necesidad del presupuesto solicitado para la ejecución del proyecto de I+D+I.
...
Este apartado solo se rellenará si se solicita la inclusión del proyecto en la convocatoria para \enquote{contratos predoctorales para la formación de doctores}. Se aportará información para cada uno de los subproyectos que soliciten la inclusión en dicha convocatoria.

Esta información se tendrá en cuenta para valorar la capacidad formativa de cada equipo de investigación, con independencia de la valoración científica que reciba el respectivo subproyecto.
...
Incorpore una breve descripción del desarrollo científico o profesional de los doctores formados, tanto por los/as IP como por alguno de los miembros del equipo de investigación, durante los últimos 10 años.

\section{Condiciones específicas para la efecución de determinados proyectos}

Este apartado sólo se rellenará si en la aplicación electrónica de \textbf{solicitud} se contesta afirmativamente a alguno de los aspectos relacionados con las condiciones o implicaciones recogidas en el Anexo IV, tales como ética, bioseguridad, experimentación animal, ensayos clínicos, utilización de células o tejidos humanos, células troncales embrionarias, realización de encuestas cuantitativas en el ámbito de las ciencias sociales, actividades arqueológicas, recursos genéticos españoles o extranjeros, etc., y únicamente en aquellos supuestos que no se contemplen en la aplicación de \textbf{solicitud} y que afecten a las actividades previstas en la propuesta presentada.
